            ...
            <div class="row tm-edit-product-row">
			  <div class="col-xl-6 col-lg-6 col-md-12">
			    <div class="form-group mb-3">
			      ...
			      <form:input id="name" type="text" class="form-control validate" path="tenSach" />
			    </div>
			    <div class="form-group mb-3">
			    ...
			    <div class="row">
			      <div class="form-group mb-3 col-xs-12 col-sm-6">
			        ...
			        <form:input id="stock" type="text" class="form-control validate" path="soLuongTon" />
			      </div>
			      <div class="form-group mb-3 col-xs-12 col-sm-6">
			        <label for="stock">Price
			        </label>
			        <form:input id="stock"  type="text" class="form-control validate" path="giaBan" />
			      </div>
			    </div>
			  ...
			  <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
			    <div class="form-group mb-3">
			      <label for="name">Link Image 1
			      </label>
			      <form:input id="name" type="text" class="form-control validate"  path="anh1" />
			    </div>
			
			    <div class="form-group mb-3">
			      <label for="name">Link Image 2
			      </label>
			      <form:input id="name" type="text" class="form-control validate"  path="anh2" />
			    </div>
			
			    <div class="form-group mb-3">
			      <label for="name">Link Image 3
			      </label>
			      <form:input id="name"  type="text" class="form-control validate" path="anh3" />
			    </div>
			
			    <div class="form-group mb-3">
			      <label for="description">Description</label>
			      <form:textarea class="form-control validate" rows="5"  path="moTa"></form:textarea>
			    </div>
			  </div>
			</div>
              <div class="col-12">
